...
const CreatePage = () => {
    ...
    const { selectedPublishingTarget, publishToCurrentPublication, selectedChildPublications, isLoading:publishLoading, errorMessage:publishErrorMessage } = useAppSelector(state => state.publishReducer)
    ...
    const handlePageCreationDone = (): void => {
        ...
        dispatch(setErrorMessage(null))
        dispatch(setPublishErrorMessage(null))
    }
    ...
    const steps = useMemo(() => [
        ...
        {
            title: "Publish",
            content: <PublishContainer isPublishRequested={isPublishRequested} setIsPublishRequested={setIsPublishRequested} pageIdToPublish={savedPage?.Id} />
        }
    ], [pageTemplate, isPublishRequested, savedPage]);
        ...
        <ConfigProvider theme={antdThemeConfig}>
            {
                <>
                    ...
                    {!!errorMessage || !!publishErrorMessage && <Alert message={errorMessage || publishErrorMessage} type="error" />}
