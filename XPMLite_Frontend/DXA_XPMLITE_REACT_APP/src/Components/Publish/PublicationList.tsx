...
const PublicationList = () => {
    ...
    const { publishToCurrentPublication, childPublications, parentPublication, selectedChildPublications } = useAppSelector(state => state.publishReducer);

    const childPublicationsSelection = {
        selectedRowKeys: selectedChildPublications,
            ...
            </div>
            {
                childPublications.length !== 0 ?
                    <Table
                        ...
                        pagination={false}
                        rowSelection={childPublicationsSelection}
