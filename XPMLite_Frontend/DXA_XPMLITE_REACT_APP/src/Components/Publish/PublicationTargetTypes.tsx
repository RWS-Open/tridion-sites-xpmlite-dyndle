...
const PublicationTargetTypes = () => {
    ...
    const { publishDate, publishingSchedule, targetTypes, selectedPublishingTarget } = useAppSelector(state => state.publishReducer);
    ...
    const targetSelection = {
        selectedRowKeys: selectedPublishingTarget,
