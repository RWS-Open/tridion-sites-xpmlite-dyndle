...
```html
    ...
    <head>
        ...
        <!-- XPMLITE START-->
        <link rel="stylesheet" href="/content/xpmlite/css/xpmlite-editor.bundle.css">
        <link rel="stylesheet" href="/content/xpmlite/css/dxa-xpmlite.bundle.css">
        <!-- XPMLITE END -->
            ...
            <script type="text/javascript">
                ...
                function getConfig(){
                    const config = {
						...
						default_binary_folderId:'@System.Configuration.ConfigurationManager.AppSettings["default_binary_folderId"]'
                ...
                if (String(window.getConfig?.().staging).toLowerCase()==="true") {
                    ...
                    editorScript.src = "/content/xpmlite/js/xpmlite-editor.bundle.js";
                    editorScript.defer = true;
                    document.head.appendChild(editorScript);
                    
                    const dxaXpmliteScript = document.createElement("script");
                    dxaXpmliteScript.src = "/content/xpmlite/js/dxa-xpmlite.bundle.js";
                    editorScript.defer = true;
...
- Update the <appSettings> and custom configuration sections in your DXA website's root Web.config file (<%WEBSITE_ROOT%>\Web.config).
        ...
        <configuration>
            <configSections>
             ...
             <appSettings>
				...
				<add key="default_binary_folderId" value="57" /> // Binary Image folder Id
                <!-- End XPMLITE -->
            </appSettings>
            .....
	...
	| `default_binary_folderId`  | The Binary image folder id for storing the uploaded images. 				   |
